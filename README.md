...
GGSEL_SELLER_OFFICE_API_BASE=https://seller.ggsel.com
...
- `GGSEL_SELLER_OFFICE_API_BASE`: defaults to `https://seller.ggsel.com` (seller-office paths already include `/api/v1/...`).
